...
RANKING_YPOS = MARGIN
WINDOW_WIDTH = n_players * WIDTH + \
    (n_players - 1) * MARGIN + 4 * MARGIN + RANKING_WIDTH
WINDOW_HEIGHT = n_players * HEIGHT + \
    (n_players - 1) * MARGIN + 3 * MARGIN + CHAT_HEIGHT
...
START_xpos = WINDOW_WIDTH / 2 - START_WIDTH / 2
START_ypos = WINDOW_HEIGHT / 2 - START_HEIGHT / 2
